            ...
            <div class="row g-5">
                    ...
                    <div class="bg-light rounded h-100 p-5">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>JL. TELEKOMUNIKASI NO. 1, TERUSAN BUAH BATU, KAWASAN TELKOM UNIVERSITY BANDUNG</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>cs@telkomedika.co.id</span>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    ...
                    <form action = "/feedback" method = "POST" >
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <textarea class="form-control border-0 bg-light px-4 py-3" rows="5" placeholder="Message" name = "message"></textarea>
                            </div>
                            <div class="col-12">
                ...
                <div class="col-xl-4 col-lg-12 wow slideInUp" data-wow-delay="0.6s">
                    <iframe class="position-relative rounded w-100 h-100"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.2708295351695!2d107.6282033148729!3d-6.9773379702625205!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e9ac24f5babb%3A0x2ca9f636654d9715!2sKlinik%20Telkomedika!5e0!3m2!1sid!2sid!4v1680363517589!5m2!1sid!2sid"
